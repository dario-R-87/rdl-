...
const CreateDocument = () => {
    ...
    const handleChange = (e) => {
        ...
        // if(name==='codart'){
        //     if(value.length>4 && value.length>formData[name].length){
        //         setShow(true)
        //     }
        // }
        setFormData({
            ...
            <Container className='mt-3'>
                ...
                <Form onSubmit={addRowHandler}>
                    ...
                    <Form.Group controlId="codart">
                        ...
                        <Form.Control placeholder="Codice" required type="text" name="codart" defaultValue={formData.codart} readOnly />
                        <Form.Control placeholder="Descrizione" type="text" name="desc" defaultValue={formData.desc} readOnly />
